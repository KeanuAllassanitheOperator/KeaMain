...
Install-ADDSDomainController -DomainName $validdomain -DelegatedAdministratorAccountName "Keanu" -DatabasePath "C:\Windows\NTDS"  -InstallDNS:$true -LogPath "C:\Windows\NTDS" -NoRebootOnCompletion:$false -SYSVOLPath "C:\Windows\SYSVOL"-Force:$true -SafeModeAdministratorPassword $(convertto-securestring -string "" -asplaintext -force)
